    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                    ...
                    <div class="dropdown profile-element admin_open">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear" style="margin-top: 20px;">
                               <span class="block m-t-xs"><strong class="font-bold">{$_admin['store_name']}</strong></span>
                                <span class="text-muted text-xs block">{$_admin['store_name'] ? $_admin['store_name'] : '管理员'}<b class="caret"></b></span>
                            </span>
                        </a>
                ...
                <!--  菜单  -->
                <li>
                    <a href="#"><i class="fa fa-laptop"></i> <span class="nav-label">商品</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/index.php/merchant/store.store_product/index/type/1.html"><i class=""></i>商品管理</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-laptop"></i> <span class="nav-label">订单</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/index.php/merchant/order.store_order/index"><i class=""></i>订单管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/index.php/merchant/store.store_product_reply/index/"><i class=""></i>评论管理</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-laptop"></i> <span class="nav-label">数据</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/index.php/merchant/record.record/chart_order"><i class=""></i>订单统计</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/index.php/merchant/record.record/chart_product"><i class=""></i>产品统计</a>
                        </li>
                    </ul>
                </li>
            </ul>

...
use app\merchant\library\FormBuilder;
...
use think\Request;
use think\Url;
use app\merchant\model\wechat\ArticleCategory as ArticleCategoryModel;
use app\merchant\model\wechat\WechatNews as WechatNewsModel;
...

{
    ...
    public function create(){
        ...
        FormBuilder::select('new_id','图文列表',function(){
            $list = \app\merchant\model\wechat\WechatNews::getNews();
            $options = [];

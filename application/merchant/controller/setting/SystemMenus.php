...
use think\Request;
use think\Url;
use app\merchant\model\system\SystemMenus as MenusModel;
...
//            ['access',''],
    ...
    public function create($cid = 0)
    {
        ...
        if (!empty($controller))
        {
            ...
            if(class_exists('\app\merchant\controller\\' . $controller))
            {
                $list = get_this_class_methods('\app\merchant\controller\\' . $controller);

...
namespace app\merchant\controller\record;
...
use app\merchant\model\ump\StoreBargain;
use app\merchant\model\ump\StoreSeckill;
use app\merchant\model\ump\StoreCombination;
use service\JsonService;
use service\UtilService as Util;
use app\merchant\model\user\User;
use app\merchant\model\user\UserBill;
use app\merchant\model\user\UserExtract;
use app\merchant\model\store\StoreCouponUser;
/**
 * 微信充值记录
 * Class UserRecharge
 * @package app\merchant\controller\user
 */

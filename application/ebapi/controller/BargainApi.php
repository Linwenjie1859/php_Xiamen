...
class BargainApi extends AuthController
{
    ...
    public function bargain_share_poster()
    {
        ...
        try{
            ...
            if(stripos($storeBargainInfo['image'], '/public/uploads/')) $data['image'] = ROOT_PATH.substr($storeBargainInfo['image'],stripos($storeBargainInfo['image'], '/public/uploads/'),strlen($storeBargainInfo['image']));

...
class PinkApi extends AuthController
{
    ...
    public function pink_share_poster()
    {
        ...
        if(stripos($storeCombinationInfo['image'], '/public/uploads/')) $data['image'] = ROOT_PATH.substr($storeCombinationInfo['image'],stripos($storeCombinationInfo['image'], '/public/uploads/'),strlen($storeCombinationInfo['image']));

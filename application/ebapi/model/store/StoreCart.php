...
class StoreCart extends ModelBasic
{
    ...
    {
        $productInfoField = 'id,mer_id,image,slider_image,price,ot_price,vip_price,postage,mer_id,give_integral,cate_id,sales,stock,store_name,store_info,unit_name,is_show,is_del,is_postage,cost,type,open_date,open_address';
        ...
        foreach ($list as $k=>$cart){
            ...
            if(!$product){
                ...
                $product['open_date']=json_decode($product['open_date']);

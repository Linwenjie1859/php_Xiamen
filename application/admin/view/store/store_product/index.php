            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        ...
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create_item')}',{h:700,w:1100})">添加游玩项目</button>
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="$eb.createModalFrame('{{d.store_name}}-编辑','{:Url('edit')}?id={{d.id}}&&type={{d.type}}',{h:700,w:1100})">
                            编辑
                        </button>

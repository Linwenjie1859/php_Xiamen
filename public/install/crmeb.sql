...
CREATE TABLE `eb_system_attachment`  (
  ...
  `image_type` tinyint(1) DEFAULT 1 COMMENT '图片上传类型 1本地 2七牛云 3OSS 4COS',
...
(113, 'order_cancel_time', 'text', 5, NULL, NULL, '', 100, NULL, '24', '普通商品未支付取消订单时间', '普通商品未支付取消订单时间，单位（小时）', 0, 1),
(114, 'order_activity_time', 'text', 5, NULL, NULL, '', 100, NULL, '2', '活动商品未支付取消订单时间', '活动商品未支付取消订单时间，单位（小时）', 0, 1),
(115, 'order_bargain_time', 'text', 5, NULL, NULL, NULL, 100, NULL, '"0"', '砍价未支付取消订单时间', '砍价未支付默认取消订单时间，单位（小时），如果为0将使用默认活动取消时间，优先使用单独活动配置', 0, 1),
(116, 'order_seckill_time', 'text', 5, NULL, NULL, NULL, 100, NULL, '"0"', '秒杀未支付订单取消时间', '秒杀未支付订单取消时间，单位（小时），如果为0将使用默认活动取消时间，优先使用单独活动配置', 0, 1),
(117, 'order_pink_time', 'text', 5, NULL, NULL, NULL, 100, NULL, '"0"', '拼团未支付取消订单时间', '拼团未支付取消订单时间,单位（小时），如果为0将使用默认活动取消时间，优先使用单独活动配置', 0, 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('upload_type' , 'radio' , 17 , '1=>本地存储\r\n2=>七牛云存储\r\n3=>阿里云OSS\r\n4=>腾讯COS' , NULL , '' , NULL , NULL , '' , '上传类型' , '文件上传的类型' , 0 , 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('uploadUrl' , 'text' , 17 , NULL , NULL , 'url:true' , 100 , NULL , '' , '空间域名 Domain' , '七牛云存储和阿里云OSS时填写' , 0 , 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('accessKey' , 'text' , 17 , NULL , NULL , '' , 100 , NULL , '' , 'accessKey' , 'accessKey' , 0 , 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('secretKey' , 'text' , 17 , NULL , NULL , '' , 100 , NULL , '' , 'secretKey' , 'secretKey' , 0 , 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('storage_name' , 'text' , 17 , NULL , NULL , '' , 100 , NULL , '' , '存储空间名称' , '存储空间名称（公开空间）' , 0 , 1);
INSERT INTO `eb_system_config` (`menu_name` , `type` , `config_tab_id` , `parameter` , `upload_type` , `required` , `width` , `high` , `value` , `info` , `desc` , `sort` , `status`) VALUES ('storage_region' , 'text' , 17 , NULL , NULL , '' , 100 , NULL , '' , '所属地域' , '腾讯COS时填写' , 0 , 1);
...
INSERT INTO `eb_system_config_tab` (`eng_title` , `status` , `title` , `icon` , `type`) VALUES ('upload_set' , 1 , '文件上传配置' , '' , 0);
